...
public class TelaListaAgendamento extends javax.swing.JFrame {

    private static final Logger logger = LogManager.getLogger(TelaListaAgendamento.class);



    public TelaListaAgendamento() {

        EntityManagerUtil.getEntityManagerFactory(); //abrimos a conexão bd
        initComponents(); //cria os componentes
        logger.info("A tela 'Lista de Consultas' foi aberta"); //criado para gerar log na abertura da tela
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListaAgendamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListaAgendamento().setVisible(true);
            }
        });
    }
